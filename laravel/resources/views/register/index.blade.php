  ...
  <div class="col-md-5">
    <main class="form-registration">
      ...
      <form action="/register" method="post">
        <!-- img gunakan jika perlu logo/yang lain -->
        ...
        <!-- gunakan jika ingin remember -->
        <!-- <div class="checkbox mb-3">
              <label>
                <input type="checkbox" value="remember-me"> Remember me
              </label>
            </div> -->
        <button class="w-100 btn btn-lg btn-primary mt-4" type="submit">Registered</button>
      </form>
      <small class="d-block text-center mt-3">Sudah Register Akun? <a href="/login">Login Now!</a></small>
    </main>
  </div>
</div>
<p class="mt-5 mb-3 text-center">&copy; Kelompok Hoha</p>
